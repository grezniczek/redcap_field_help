...
$(document).ajaxSuccess(function() {
    if ($('textarea#field_label').length == 1) {
        ...
        div.append('<div style="font-weight:normal;float:right;padding-right:27px"><a onclick="redcap_field_help_em_fieldHelpExplainPopup();return false;" href="javascript:;" style="font-size:11px;"><i class="far fa-question-circle"></i> How to use Field Help</a></div>')
    }
})